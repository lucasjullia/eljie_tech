...
The purpose of these GTC is to define the terms and conditions under which the Publisher sells digital content and services to the User, accessible exclusively through the Application.
...
The Publisher never has access to the User’s banking details. The transaction is deemed final once validated by the relevant payment platform.
...
The Application, its content, code, structure and graphical elements are protected by intellectual property laws. The purchase of a subscription grants only a personal, non-exclusive and non-transferable right of use. Any resale or commercial exploitation is strictly prohibited.
...
The Publisher shall not be held liable in the event of force majeure or events beyond its control (network failures, service provider outages, decisions by Apple or Google platforms, etc.).
...
These General Terms and Conditions of Sale are drafted in French and may be translated into English for informational purposes only.
