...
* **Intelligence artificielle :** DeepInfra (modèle OSS-120B) et Baseten (modèle DeepSeek V4 Flash)

* **Données sportives :** api-football.com (aucune donnée personnelle transmise)



Chaque prestataire agit en tant que sous-traitant au sens du RGPD et applique ses propres mesures de conformité.
...
* **États-Unis :** prestataires d'hébergement, d'authentification, de paiement, de publicité et d'IA (Google Cloud Platform, DeepInfra, Baseten, RevenueCat, GitHub).
...
L’Éditeur ne saurait être tenu responsable des conséquences liées à l’utilisation ou à l’interprétation des réponses générées. Tout usage visant à produire des contenus illégaux, haineux, diffamatoires ou dangereux est strictement interdit.
